    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (emojiFilter) {
                ...
                if (!matchingReaction) {
                    return interaction.editReply(`No reactions found for emoji: ${emojiFilter}`);
                }

                targetReactions = new Map([[matchingReaction.emoji.toString(), matchingReaction]]);
            }
...
${userList}\n`);
            ...
            if (reactionData.length === 0) {
                return interaction.editReply('No reactions found for the specified criteria.');
            }
