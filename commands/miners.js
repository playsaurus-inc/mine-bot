    ...
    module.exports = {
        ...
        async execute(interaction)
        {
            ...
            await interaction.reply({content: "Miners increase mining speed by 10% each.\nUpgrades increase mining speed by 10% each.\nMiners find chests for you, the deeper you go the more chances of chests.", ephemeral: shared })
        }
    }
