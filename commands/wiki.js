...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply({ content: "Go to https://mrmine.fandom.com/wiki/Mr._Mine_Wiki. It is updated frequently, check it out if you need more detailed information about the game. ", ephemeral: shared })
    }
}
